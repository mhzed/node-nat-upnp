...
Ssdp.prototype.createSocket = function createSocket(intf) {
  var self = this;
  var socket = dgram.createSocket(intf.family === 'IPv4' ?
                                  'udp4' : 'udp6');
  ...
  process.nextTick(function() {
    ...
    socket.address = intf.address;
    socket.bind(self._sourcePort, intf.address);
  });
